...
def main():
    ...
    dl = DataLoader(ds, batch_size=16, shuffle=False, collate_fn=ds.collate_fn)
    for batch_idx, (image, annots) in enumerate(dl):
        ...
        vis_bef.save(SAMPLES_DIR/f"{batch_idx}-before.jpg")
        ...
        vis_aft.save(SAMPLES_DIR/f"{batch_idx}-after.jpg")
        if batch_idx >= 10:
            break
